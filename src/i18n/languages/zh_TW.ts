...
export const zh_TW: Translation = {
	...
	[Key.comments]: "評論",
	[Key.links]: "連結",
	[Key.linksSubtitle]: "推薦連結",
	[Key.linksSearchPlaceholder]: "搜尋連結...",
	[Key.linksFilterAll]: "全部",
	[Key.linksNoResults]: "暫無連結",
	[Key.linksVisit]: "訪問",
	[Key.linksCopyLink]: "複製鏈接",
	[Key.linksCopySuccess]: "複製成功！",
	[Key.linksTags]: "標籤",
	[Key.untitled]: "無標題",
